...
const ToolModal = ({ onClose, title, style, className, contentClass, size, children, disableOverlayClick = false, ...rest }) => {
    let sizingStyles;
    ...
    return (
        ...
        >
            <div className={styles.toolModal}>
                ...
                <div className={[styles.container, contentClass].join(' ')}>
                    {children}
                </div>
            </div>
        </Modal>
